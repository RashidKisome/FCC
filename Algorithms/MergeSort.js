...
A good way to implement this is to write one function, for instance merge, which is responsible for merging two sorted arrays, and another function, for instance mergeSort, which is responsible for the recursion that produces single-item arrays to feed into merge. Good luck!


*/

// // helper function, assuming that leftArr and rightArr are sorted
// const merge = (leftArr, rightArr) => {
//   const output = [];
//   // depending on which output, left element or right element is smaller, we will push them into the output array untill its filled
//   let leftIndex = 0;
//   let rightIndex = 0;

//   while (leftArr < leftArr.length && rightIndex < rightArr.length) {
...
//     }
//   }
//   // either the left will give some elements, or the right
//   return [...output, ...leftIndex.slice(leftIndex), ...rightArr(rightIndex)];
// };

// // // recursive function
// // const arraySort = (array) => {
// //   // edge case, when our parameter array has a length less than or equal to 1
// //   if (array.length < 1) {
// //     return array;
// //   }
